...
class CloudSession extends BaseSession {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (guards_1.isSuperAgentError(e) && e.response.status === 401) {
                    throw new errors_1.FatalException(chalk_1.default.red('Incorrect email or password'));
                }
                throw e;
            }
        });
    ...
    getAppUserToken(app_id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!c.tokens.appUser[app_id]) {
                throw new errors_1.FatalException(`A token does not exist for your account on app ${chalk_1.default.bold(app_id)}.`);
            }
...
function promptToLogin(env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { validators } = yield Promise.resolve().then(function () { return require('@ionic/cli-framework/lib'); });
