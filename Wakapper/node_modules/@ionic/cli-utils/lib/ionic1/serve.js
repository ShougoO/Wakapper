...
function serve({ env, options }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { ERROR_NETWORK_ADDRESS_NOT_AVAIL, findClosestOpenPort } = yield Promise.resolve().then(function () { return require('../utils/network'); });
        const [externalIP, availableIPs] = yield serve_1.selectExternalIP(env, options);
